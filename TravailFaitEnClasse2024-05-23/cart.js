...
books.map(book => {
	...
	let trQty = document.createElement('tr');
	inputQty.type="number"
	inputQty.min = "0"
	inputQty.max = book.stock
    ...
    let price = parseInt(totalTd.textContent.slice(1, totalTd.textContent.lenght))
    if(!isNaN()){
    	totalprice += price;
    }
